...
**Tutorial:** We will be using the `Crop Image` module to slightly crop the sides of our image. 
...
**Tutorial:** We will be using the "A" channel with a single cutoff to mask our plants.
...
**Tutorial:** We will be running morphology and color analysis on our demo image.
...
**Tutorial:** Let's look at the data from our demo analysis.
